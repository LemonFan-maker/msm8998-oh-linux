...
/**
 * struct access_token - OpenHarmony Access Token Info (Kernel-side)
 * This must match the layout of the UAPI definition in binder.h
 */
struct access_token {
	u64 sender_tokenid; // <-- 使用 u64，而不是 __u64
	u64 first_tokenid;  // <-- 使用 u64
	u64 reserved[2];    // <-- 不要忘了 reserved 字段！
};
#endif /* CONFIG_ACCESS_TOKENID */

// struct binder_extended_error {
//     u32 id;      // <-- 内核中使用 u32
//     u32 command; // <-- 内核中使用 u32
//     s32 param;   // <-- 内核中使用 s32
// };
